// @observablehq/runtime v4.22.3 Copyright 2022 Observable, Inc.
function e(e, t, n) {
    n = n || {};
...
const {getOwnPropertySymbols: a, prototype: {hasOwnProperty: s}} = Object, {toStringTag: c} = Symbol, l = {}, u = a;
...
const {getPrototypeOf: b, getOwnPropertyDescriptors: v} = Object, w = b({});
...
function _(n, i, o, a) {
    ...
    p.innerHTML = "<svg width=8 height=8 class='observablehq--caret'>\n    <path d='M4 7L0 1h8z' fill='currentColor' />\n  </svg>", p.appendChild(document.createTextNode(`${s}${d ? " [" : " {"}`)), p.addEventListener("mouseup", (function (e) {
        e.stopPropagation(), ae(h, P(n, null, o, a))
    })), c = c(n);
...
function P(e, n, i, o) {
    let a, s, c, l, u = t(e);
    if (e instanceof Map ? e instanceof e.constructor ? (a = `Map(${e.size})`, s = L) : (a = "Map()", s = I) : e instanceof Set ? e instanceof e.constructor ? (a = `Set(${e.size})`, s = M) : (a = "Set()", s = I) : u ? (a = `${e.constructor.name}(${e.length})`, s = U) : (l = m(e)) ? (a = `Immutable.${l.name}${"Record" === l.name ? "" : `(${e.size})`}`, u = l.arrayish, s = l.arrayish ? R : l.setish ? k : D) : (a = f(e), s = I), n) {
        const t = document.createElement("span");
        return t.className = "observablehq--shallow", i && t.appendChild(r(i)), t.appendChild(document.createTextNode(a)), t.addEventListener("mouseup", (function (n) {
            S(t) || (n.stopPropagation(), ae(t, P(e)))
        })), t
    }
...
function he(e) {
    var t, n = e.getUTCHours(), r = e.getUTCMinutes(), i = e.getUTCSeconds(), o = e.getUTCMilliseconds();
...
function pe(e) {
    ...
    function r(e, t) {
        var r, i = [], o = e.length, a = 0, s = 0, c = o <= 0, l = !1;
        ...
        function u() {
            ...
            for (; a < o;) {
                if (10 === (r = e.charCodeAt(t = a++))) l = !0; else if (13 === r) l = !0, 10 === e.charCodeAt(a) && ++a; else if (r !== n) continue;
                return e.slice(i, t)
            }
...
var me = pe(","), be = me.parse, ve = me.parseRows, we = pe("\t"), _e = we.parse, ye = we.parseRows;
...
const xe = Ce("d3", "7.4.4", "dist/d3.min.js"), Ne = Ce("@observablehq/inputs", "0.10.4", "dist/inputs.min.js"),
    je = Ce("@observablehq/plot", "0.5.0", "dist/plot.umd.min.js"),
    Te = Ce("@observablehq/graphviz", "0.2.1", "dist/graphviz.min.js"),
    Ae = Ce("@observablehq/highlight.js", "2.0.0", "highlight.min.js"),
    $e = Ce("@observablehq/katex", "0.11.1", "dist/katex.min.js"), qe = Ce("lodash", "4.17.21", "lodash.min.js"),
    Oe = Ce("htl", "0.3.1", "dist/htl.min.js"), Se = Ce("jszip", "3.10.0", "dist/jszip.min.js"),
    Pe = Ce("marked", "0.3.12", "marked.min.js"), Le = Ce("sql.js", "1.7.0", "dist/sql-wasm.js"),
    Me = Ce("vega", "5.22.1", "build/vega.min.js"), ke = Ce("vega-lite", "5.2.0", "build/vega-lite.min.js"),
    Re = Ce("vega-lite-api", "5.0.0", "build/vega-lite-api.min.js"),
    Ue = Ce("apache-arrow", "4.0.1", "Arrow.es2015.min.js"), Ie = Ce("arquero", "4.8.8", "dist/arquero.min.js"),
    De = Ce("topojson-client", "3.1.0", "dist/topojson-client.min.js"),
    Fe = Ce("exceljs", "4.3.0", "dist/exceljs.min.js"), Be = Ce("mermaid", "9.1.1", "dist/mermaid.min.js"),
    ze = Ce("leaflet", "1.8.0", "dist/leaflet.js"), He = new Map, We = [], Ve = We.map, Ge = We.some,
    Ze = We.hasOwnProperty, Ye = /^((?:@[^/@]+\/)?[^/@]+)(?:@([^/]+))?(?:\/(.*))?$/, Je = /^\d+\.\d+\.\d+(-[\w-.+]+)?$/,
    Ke = /(?:\.[^/]*|\/)$/;
...
function Qe(e = "https://cdn.jsdelivr.net/npm/", t = ["unpkg", "jsdelivr", "browser", "main"]) {
    ...
    return async function (r, i) {
        ...
        const a = await n(o);
        return `${e}${a.name}@${a.version}/${o.path || function (e) {
            for (const n of t) {
                let t = e[n];
                if ("string" == typeof t) return t.startsWith("./") && (t = t.slice(2)), Ke.test(t) ? t : `${t}.js`
            }
        }(a) || "index.js"}`
    }
}
...
function nt(e) {
    const t = {};
    for (const n of e) for (const e in n) Ze.call(n, e) && (null == n[e] ? Object.defineProperty(t, e, {get: rt(n, e)}) : t[e] = n[e]);
    return t
}
...
class SQLiteDatabaseClient {
    ...
    async explain(e, t) {
        return ut("pre", {className: "observablehq--inspect"}, [dt((await this.query(`EXPLAIN QUERY PLAN ${e}`, t)).map((e => e.detail)).join("\n"))])
    }

    async describeTables({schema: e} = {}) {
        return this.query(`SELECT schema, name
                           FROM pragma_table_list()
                           WHERE type = 'table' ${null == e ? "" : " AND schema = ?"} AND name NOT LIKE 'sqlite_%'`, null == e ? [] : [e])
    }

    async describeColumns({schema: e, table: t} = {}) {
        if (null == t) throw new Error("missing table");
        const n = await this.query(`SELECT name, type, "notnull"
                                    FROM pragma_table_info(?${null == e ? "" : ", ?"})
                                    ORDER BY cid`, null == e ? [t] : [t, e]);
        if (!n.length) throw new Error(`table not found: ${t}`);
        return n.map((({name: e, type: t, notnull: n}) => ({name: e, type: ct(t), databaseType: t, nullable: !n})))
    }
    ...
    async describe(e) {
        ...
        const {columns: n} = t;
        return ut("table", {value: t}, [ut("thead", [ut("tr", n.map((e => ut("th", [dt(e)]))))]), ut("tbody", t.map((e => ut("tr", n.map((t => ut("td", [dt(e[t])])))))))])
    }
...
class Workbook {
    ...
    sheet(e, t) {
        ...
        return function (e, {range: t, headers: n} = {}) {
            ...
            for (let t = i; t <= a; t++) {
                const n = l[t - i] = Object.create(null, {"#": {value: t + 1}}), a = e.getRow(t + 1);
                if (a.hasValues) for (let e = r; e <= o; e++) {
...
async function bt(e) {
    ...
    if (!t.ok) throw new Error(`Unable to load file: ${e._url.pathname}`); //if (!t.ok) throw new Error(`Unable to load file: ${e.name}`); -- changed by user Lovepreet
    return t
}
...
var xt = {
    canvas: function (e, t) {
        ...
        if (t) for (var a in t) i = (r = a).indexOf(":"), n = t[a], i >= 0 && "xmlns" !== (r = a.slice(0, i)) && (a = a.slice(i + 1)), yt.hasOwnProperty(r) ? o.setAttributeNS(yt[r], a, n) : o.setAttribute(a, n);
        return o
    }, input: function (e) {
...
var qt = {
    disposable: Tt, filter: function* (e, t) {
...
var Library = Object.assign(Object.defineProperties((function (e) {
    ...
    Object.defineProperties(this, (n = {
        ...
        html: () => St,
        md: () => function (e) {
            return e(Pe.resolve()).then((function (t) {
        ...
        _: () => t(qe.resolve()),
        aq: () => t.alias({"apache-arrow": Ue.resolve()})(Ie.resolve()),
        Arrow: () => t(Ue.resolve()),
        d3: () => t(xe.resolve()),
        Inputs: () => t(Ne.resolve()).then((e => ({...e, file: e.fileOf(wt)}))),
        L: () => async function (e) {
    ...
    resolve: {get: () => at.resolve, enumerable: !0, configurable: !0}, require: {
        get: () => at, set: function (e) {
            at = e
...
var Ht = Array.prototype, Wt = Ht.map, Vt = Ht.forEach;
...
function Variable(e, t, n) {
    ...
    n || (n = Jt), Object.defineProperties(this, {
        ...
        _definition: {value: Qt, writable: !0},
        ...
        _reachable: {value: n !== Jt, writable: !0},
        _rejector: {
...
function Module(e, t = []) {
    Object.defineProperties(this, {
        ...
        _builtins: {value: new Map([["invalidation", sn], ["visibility", cn], ...t])},
    ...
    _copy: {
        value: function (e, t) {
            ...
            for (const [o, a] of this._scope) {
                ...
                if (!n || 1 !== n._type) if (a._definition === Zt) {
        ...
        value: function (e) {
            ...
            if (!n) if (n = new Variable(2, this), this._builtins.has(e)) n.define(e, Gt(this._builtins.get(e))); else if (this._runtime._builtin._scope.has(e)) n.import(e, this._runtime._builtin); else {
                try {
        ...
        value: function (e, t) {
            ...
            return n._source = this, Vt.call(e, (function (e) {
                ...
                for (const t of e) for (const n of t._scope.values()) if (n._definition === Zt) {
        ...
        value: async function (e) {
            var t = this._scope.get(e);
            if (!t) throw new RuntimeError(e + " is not defined");
            t._observer === Jt && (t._observer = !0, this._runtime._dirty.add(t));
            return rn(this._runtime, t)
        }, writable: !0, configurable: !0
    }, variable: {
        value: function (e) {
...
function Runtime(e = new Library, t = vn) {
    ...
    if (Object.defineProperties(this, {
        ...
        _builtin: {value: n},
        _global: {value: t}
    }), e) for (var r in e) new Variable(2, n).define(r, [], e[r])
}
...
function pn(e, t) {
    let n, r, i = "function" == typeof IntersectionObserver && t._observer && t._observer._node, o = !i, a = Yt, s = Yt;
...
Object.defineProperties(Runtime, {
    load: {
        value: function (e, t, n) {
            ...
            const {modules: r, id: i} = e, o = new Map, a = new Runtime(t), s = c(i);
    ...
    _precompute: {
        ...
        value: function (e, t = Yt, c, u) { // value: function (e, t = Yt) { -- changed by user Lovepreet
            let n;

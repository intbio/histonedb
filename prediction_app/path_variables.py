...
# Working paths
APP_DIRECTORY                    = os.path.join("prediction_app")
LOG_DIRECTORY                    = os.path.join(APP_DIRECTORY, "log")
...
PREDICTION_DIRECTORY             = os.path.join(APP_DIRECTORY, "prediction")
...
DUMPS_PICKLE                     = os.path.join(PREDICTION_DUMPS_DIRECTORY, "dump_{}.pickle")
